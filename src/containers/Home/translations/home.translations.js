...
const customTranslation = {
  ...
  es: {
    getStartedMessage:
      "Para empezar, edite <code>src/App.js</code> y guarde para recargar."
  },
  fr: {
    getStartedMessage:
      "pour commencer, éditez <code>src/App.js</code> et sauvegardez pour recharger."
  },
  ru: {
    getStartedMessage:
  ...
  he: {
    getStartedMessage:
      "ושמור על מנת לטעון מחדש <code>src/App.js</code> על מנת להתחיל, ערוך את"
  }
};
